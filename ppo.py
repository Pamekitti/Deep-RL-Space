...
def parse_args():
    ...
    parser.add_argument('--num-steps', type=int, default=128,  # Specify how much data we want to collect
    ...
    args.batch_size = int(args.num_envs * args.num_steps)  # Rollouts Data = 4 * 128 = 512 datapoints per training
...
if __name__ == "__main__":
    ...
    for update in range(1, num_updates + 1):
        # 4. Annealing the rate if instructed to do so.
        if args.anneal_lr:
        ...
        # 5. GAE bootstrap reward if not done
        with torch.no_grad():
        ...
        # 6. Minibatches: flatten the batch
